                        ...
                        <div className="flex items-center justify-between p-6 border-b border-blue-500/30 bg-blue-950/20 relative overflow-hidden">
                            ...
                            <div className="flex items-center gap-4 z-10">
                                ...
                                <div className="flex items-center gap-3">
                                    <span className="text-[11px] font-black text-primary uppercase tracking-[0.3em] bg-primary/10 px-3 py-1 rounded-full">{project.category}</span>
                                    <span className="text-[11px] font-mono text-slate-300 tracking-tighter border-l border-slate-700 pl-3">v2.4.0_STABLE</span>
                                </div>
                            </div>
                            <button
                                onClick={onClose}
                                className="p-3 rounded-full hover:bg-white/10 text-slate-200 hover:text-white transition-colors z-10"
                            >
                                <X size={24} />
                            </button>
                                ...
                                <div className="space-y-8">
                                    <div>
                                        ...
                                        <div className="p-6 bg-slate-950 rounded-2xl border border-slate-800 relative group">
                                            ...
                                            <div className="absolute top-4 right-4 text-[11px] font-mono text-slate-600">FIG 1.0</div>
                                            <div className="flex justify-between items-center mb-8">
                                                <div className="w-16 h-16 border border-slate-700 rounded-lg flex items-center justify-center text-slate-300 text-[13px]">INPUT</div>
                                                ...
                                                <div className="w-16 h-16 border border-slate-700 rounded-lg flex items-center justify-center text-slate-300 text-[13px]">OUTPUT</div>
                                            </div>
                                    ...
                                    <div>
                                        ...
                                        <div className="grid grid-cols-3 gap-4">
                                            {(project.stats || []).map((stat: { label: string; value: string }, idx: number) => (
                                                <div key={idx} className="p-4 bg-slate-900/50 rounded-2xl border border-white/5">
                                                    <p className="text-[11px] font-black text-slate-300 uppercase tracking-widest mb-1">{stat.label}</p>
